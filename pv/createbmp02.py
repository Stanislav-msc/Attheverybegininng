...
bmpw=128 #bitmap width: 4 bytes little signed
bmph=128#bitmap heigh: 4 bytes little signed
...
data=[]
print(datain)
for n in range(len(datain)*4):
    rowd=[]
    i=floor(n/4)
    #y=datain[i][1]
    #print (i,y)
    rowd.append(datain[i][0]*2)
    rowd.append(datain[i][1]*2)
    rowd+=[datain[i][2]]
    data+=[rowd]
    print (rowd)
print(data)
